...
10% for course participation. Checked by name tag. Everyone is expected for actively .


#### Project Elevator Pitch

Every talk will take 5 mins. Stop watch will be used to notify the presenter.
...
1. Research project: Project scope should be commensurate with group size &ndash; an individual project is acceptable, though advised against. A core goal of the project is to
