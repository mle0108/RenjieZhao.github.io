...
Since the papers covers a lot of different fields, you are not required to dig into every corner and totally understand every technical details. (No one is able to be an expert of all fields). You can go though fastly .
...
10% for course participation. Checked by name tag. Reasonable is acceptable


#### Project Elevator Pitch

In order to provide timely feedbacks on the projects during the whole semester. The elevator pitch are not need to be well constructed and designed. You can just briefly discuss what you have done recently.
...
2. Reproduce and explore. If you do not have, you can pick some interesting paper that interest you and try to first reproduce the designs.


You can reuse your own research project for the class project. But in this case, the completion level of the project will be higher. 
...
<table class="table table-bordered table-hover">
    ...
    <tr class="table-warning">
      <td>Jan&nbsp;30</td>
      <td colspan="2">Project grouping and discussion lead registration</td>
      <td>
          Work with Jienan to register your project group; 
          <br> And sign up for one discussion to lead. 
          <!-- 
    ...
    <tr>
        ...
        <td>Zhao</td>
        <td>Spend more time with projects</td>
    </tr>
    <tr>
      <td>Feb&nbsp;22</td>
      <td>
      ...
      <td>
        ...
        <ul>
          ...
          <li><a href="https://dl.acm.org/doi/10.1145/1031495.1031508">Versatile low power media access for wireless sensor networks (Also check <a href="https://inet.omnetpp.org/docs/showcases/wireless/sensornetwork/doc/index.html#b-mac">MAC Protocols for Wireless Sensor Networks</a></li>
        </ul>
        <hr />
        For those wanting more...
        <ul>
    ...
    <tr>
      <td>Feb&nbsp;29</td>
      <td>
        ULP Backscatter (Also HotMobile)
        <hr />
        Pre-reading questions:
        <ul>
    ...
    <tr>
        ...
        <ul>
          ...
          <li>What is the difference with RADAR?</li>
          <li>What is the other techniques that you know can be used for wireless localization?</li>
        </ul>
        </td>
        <td><i>Put your name here!</i></td>
        <td>
    ...
    <tr>
      ...
      <td>
        ...
        Pre-reading questions:
        <ul>
          <li>What is device free sensing? </li>
          <li>What is the difference with the wireless localization? Why it is </li>
    ...
    <tr>
        <td>Apr&nbsp;2</td>
        <td>
        <a href="#">Heart and Breath Rate</a>
        <hr />
        Pre-reading questions:
        <ul>
          <li>What is RFID? What is the different from the communication schemes mentioned last week?</li>
    ...
    -->
    <tr class="table-info">
      <td colspan="4">Week 14: Project Week</td>
      <!--
    ...
    <tr>
      <td>Apr&nbsp;23</td>
      <td>In-person class is cancelled. You&rsquo;re encouraged to check out <a href="https://sigops.org/s/conferences/hotos/2021/">Dhanajay and Nishant's presentation at HotOS</a>, which starts just before the normal during class period (and to participate in the discussion there!). Otherwise, please use the time to improve your projects and writeups.</td>
      <td colspan="2">
